...
public class CookieAuthenticationStateProviderReference(IHttpClientFactory httpClientFactory, ILogger<CookieAuthenticationStateProviderReference> logger)
    ...
    public override async Task<AuthenticationState> GetAuthenticationStateAsync()
    {
        ...
        try
        {
            ...
            if (userInfo != null)
            {
                ...
                // set the principal
                var id = new ClaimsIdentity(claims, nameof(CookieAuthenticationStateProviderReference));
