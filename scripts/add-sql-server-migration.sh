...
echo "Target project: RevrenLove.Ledger.Persistence.SqlServer"

dotnet ef migrations add "$MIGRATION_NAME" \
    --startup-project RevrenLove.Ledger.Api/RevrenLove.Ledger.Api.csproj \
    --project RevrenLove.Ledger.Persistence.SqlServer/RevrenLove.Ledger.Persistence.SqlServer.csproj
