...
{
    [DbContext(typeof(LedgerSqlServerDbContext))]
    partial class LedgerSqlServerDbContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("RevrenLove.Ledger.Entities.FinancialTransaction", b =>
                {
                    ...
                    b.ToTable("FinancialTransactions", t =>
                        {
                            t.HasCheckConstraint("CK_FinancialTransaction_Description_MinLength", "LEN(TRIM(Description)) >= 1");
                        });
                });
