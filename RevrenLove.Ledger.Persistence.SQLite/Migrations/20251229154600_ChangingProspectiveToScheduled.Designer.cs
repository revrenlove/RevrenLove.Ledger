...
namespace RevrenLove.Ledger.Persistence.SQLite.Migrations
{
    ...
    [Migration("20251229154600_ChangingProspectiveToScheduled")]
    partial class ChangingProspectiveToScheduled
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RevrenLove.Ledger.Entities.ScheduledTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RevrenLove.Ledger.Entities.ScheduledTransaction", b =>
                {
                    b.HasOne("RevrenLove.Ledger.Entities.FinancialAccount", "DestinationFinancialAccount")
                        .WithMany("ScheduledIncomingTransactions")
                        .HasForeignKey("DestinationFinancialAccountId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("RevrenLove.Ledger.Entities.FinancialAccount", "FinancialAccount")
                        .WithMany("ScheduledOutgoingTransactions")
                        .HasForeignKey("FinancialAccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RevrenLove.Ledger.Entities.FinancialAccount", b =>
                {
                    ...
                    b.Navigation("ScheduledIncomingTransactions");

                    b.Navigation("ScheduledOutgoingTransactions");
                });
