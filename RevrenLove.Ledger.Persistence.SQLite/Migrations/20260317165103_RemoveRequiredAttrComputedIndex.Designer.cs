...
namespace RevrenLove.Ledger.Persistence.SQLite.Migrations
{
    ...
    [Migration("20260317165103_RemoveRequiredAttrComputedIndex")]
    partial class RemoveRequiredAttrComputedIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RevrenLove.Ledger.Entities.FinancialTransaction", b =>
                {
                    ...
                    b.Property<string>("ComputedDisplayValue")
                        .IsRequired()
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("TEXT")
                        .HasComputedColumnSql("strftime('%Y-%m-%d', Date) || '|' || Amount || '|' || Id", true);
