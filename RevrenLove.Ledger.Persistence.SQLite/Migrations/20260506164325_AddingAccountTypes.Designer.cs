...
namespace RevrenLove.Ledger.Persistence.SQLite.Migrations
{
    ...
    [Migration("20260506164325_AddingAccountTypes")]
    partial class AddingAccountTypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RevrenLove.Ledger.Entities.InstallmentAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RevrenLove.Ledger.Entities.RecurringExpenseAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("RecurringExpenseAccounts");
                });
            ...
            modelBuilder.Entity("RevrenLove.Ledger.Entities.RevolvingAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("RevolvingAccounts");
                });

            modelBuilder.Entity("RevrenLove.Ledger.Entities.RunningBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RevrenLove.Ledger.Entities.RecurringTransaction", b =>
                {
                    ...
                    b.HasOne("RevrenLove.Ledger.Entities.FinancialAccount", "FinancialAccount")
                        .WithMany("RecurringOutgoingTransactionsTransactions")
                        .HasForeignKey("FinancialAccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RevrenLove.Ledger.Entities.RunningBalance", b =>
                {
                    b.HasOne("RevrenLove.Ledger.Entities.FinancialTransaction", "FinancialTransaction")
                        .WithOne("RunningBalance")
                        .HasForeignKey("RevrenLove.Ledger.Entities.RunningBalance", "FinancialTransactionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RevrenLove.Ledger.Entities.FinancialAccount", b =>
                {
                    ...
                    b.Navigation("RecurringOutgoingTransactionsTransactions");
                });
